-- Migration 005: add a `steps` JSONB column to sync_log, so a full_sync run's per-step
...
-- issue #62. Numbered 005 (not 004) since 004_cr_sync_watermark.sql (issue #45) landed
-- on main first.
--
